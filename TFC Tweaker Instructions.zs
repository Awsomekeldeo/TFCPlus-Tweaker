...
//Add Anvil Recipe
//-----------------------------------------------
//OutputStack, InputStack1, InputStack2[Optional], PlanName, AnvilType (Range 0-7), CraftingValue (Range 0-50)
//mods.Terrafirmacraft.Anvil.addAnvilRecipe(<minecraft:shears>, <terrafirmacraft:item.Wrought Iron Sheet>, <terrafirmacraft:item.Wrought Iron Sheet>, "shears", 3, 35);

//mods.Terrafirmacraft.Anvil.addAnvilRecipe(<minecraft:iron_sword>, <minecraft:iron_ingot>, "sword", 3, 45);

//-----------------------------------------------
//Remove Anvil Recipe
//-----------------------------------------------
//OutputStack, InputStack1, InputStack2 [Optional], PlanName, AnvilType (Range 0-7)
...
//-------------------------------------------------
//OutputStack (Optional), OutputFluid(in mb), InputStack, InputFluid(in mb), MinTechLevel (Default: 1, Optional), Sealed (Default: true, Optional), SealedTime (Default: 8, Optional), RemoveLiquid (Default: true, Optional), AllowAnyStack (Default: true, Optional)
...
//mods.Terrafirmacraft.Barrel.addItemFluidConversion(<liquid:tannin> * 1000, <minecraft:log>, <liquid:freshwater> * 1000, 0, false, 0, true, false);
...
//OutputStack, InputStack, InputFluid(in mb), MinTechLevel (Default: 1, Optional), Sealed (Default: true, Optional), SealedTime (Default: 8, Optional), AllowAnyStack (Default: true, Optional)
//mods.Terrafirmacraft.Barrel.addItemConversion(<terrafirmacraft:item.Mortar>, <minecraft:sand>, <liquid:limewater> * 100, 0, true, 8, true);
//mods.Terrafirmacraft.Barrel.addItemConversion(<terrafirmacraft:item.Mortar>, <minecraft:sand>, <liquid:limewater> * 100, 0, true, 8);
//mods.Terrafirmacraft.Barrel.addItemConversion(<terrafirmacraft:item.Mortar>, <minecraft:sand>, <liquid:limewater> * 100, 0);
//mods.Terrafirmacraft.Barrel.addItemConversion(<terrafirmacraft:item.Mortar>, <minecraft:sand>, <liquid:limewater> * 100);
...
//-----------------------------------------------
//OutputFluid(in mb), InputFluid(in mb), MinTechLevel (Default: 1, Optional), Sealed (Default: true, Optional), SealedTime (Default: 1, Optional)
...
//Add Recipe
//-----------------------------------------------
//OutputStack, InputStack, CosmeticLoomOverlay (Range 1-3: 1-String, 2-Silk, 3-Rope; Default: 1)[Optional]
